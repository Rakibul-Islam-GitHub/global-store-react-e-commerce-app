        ...
        <header className="bg-dark py-5">
            <div className="container px-4 px-lg-5 my-5">
                <div className="text-center text-white">
                    <h1 className="display-4 fw-bolder">Grab Your Desired Product Now!</h1>
                    <p className="lead fw-normal text-white-50 mb-0">You Can Buy From a Thousands of Options</p>
                    <div className='mt-3'>
                    <a className='btn1' href="#">Shop Now</a>
                    </div>
